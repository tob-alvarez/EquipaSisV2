...
import { borra_procesos } from "./funciones_proceso";
...
const ModalBorrar = ({dato}) => {
    ...
    const borra_proceso = () => {
        ...
        borra_procesos(datos_cambios).then(() => {
            setIsModalDeleteOpen(false);
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title> {t("proceso.borrarTitulo")}...</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {dato.habilita_3 == 'SI' ? (
                        <>
                            <h6>
                                <b>{t("proceso.titulo")}:</b> {dato.nombre_proceso}
                            </h6>
                        </>
                    ) : (
                        <>
