...
import { borra_clientes } from "./funciones_cliente";
...
const ModalBorrar = ({dato}) => {
    ...
    const borra_cliente = () => {
        ...
        borra_clientes(datos_cambios).then(() => {
            setIsModalDeleteOpen(false);
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title> {t("cliente.borrarTitulo")}...</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {dato.habilita_3 == 'SI' ? (
                        <>
                            <h6>
                                <b>{t("cliente.titulo")}:</b> {dato.nombre_cliente}
                            </h6>
                        </>
                    ) : (
                        <>
