...
import { alta_tipo_usuarios } from "./funciones_tipo_usuario";
...
const ModalAgregar = () => {
  ...
  const acepta_accion = () => {
    ...
    if (nombre_tusuario === "" || observacion === "") {
      toast.error(`${t("tipo_usuario.datoObligatorio")}`);
      return;
    }
    

    alta_tipo_usuarios(datos_cambios).then((respuesta_accion) => {
