...
import { alta_tipo_tareas } from "./funciones_tipo_tarea";
...
const ModalAgregar = () => {
  ...
  const acepta_accion = () => {
    ...
    if (nombre_ttarea === "") {
      toast.error(`${t("tipo_tarea.datoObligatorio")}`);
      return;
    }
    

    alta_tipo_tareas(datos_cambios).then((respuesta_accion) => {
