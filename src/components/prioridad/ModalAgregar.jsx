...
import { alta_prioridades } from "./funciones_prioridad";
...
const ModalAgregar = () => {
  ...
  const acepta_accion = () => {
    ...
    if (nombre_prioridad === "") {
      toast.error(`${t("prioridad.datoObligatorio")}`);
      return;
    }
    

    alta_prioridades(datos_cambios).then((respuesta_accion) => {
