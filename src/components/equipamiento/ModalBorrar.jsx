...
import { borra_acciones } from "./funciones_equipamiento";
...
const ModalBorrar = ({dato}) => {
    ...
    const borra_accion = () => {
        const datos_cambios = {
            id_equipamiento: dato.id_equipamiento,
        };
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title> {t("equipamiento.borrarTitulo")}...</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {dato.habilita_3 == 'SI' ? (
                        <>
                            <h6>
                                <b>{t("equipamiento.titulo")}:</b> {dato.nombre_tequipo}
                            </h6>
                        </>
                    ) : (
                        <>
