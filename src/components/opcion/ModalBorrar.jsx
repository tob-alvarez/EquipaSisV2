...
import { borra_opciones } from "./funciones_opcion";
...
const ModalBorrar = ({dato}) => {
    ...
    const borra_opcion = () => {
        ...
        borra_opciones(datos_cambios).then(() => {
            setIsModalDeleteOpen(false);
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title> {t("opcion.borrarTitulo")}...</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {dato.habilita_3 == 'SI' ? (
                        <>
                            <h6>
                                <b>{t("opcion.titulo")}:</b> {dato.nombre_opcion}
                            </h6>
                        </>
                    ) : (
                        <>
