...
import { borra_personas } from "./funciones_persona";
...
const ModalBorrar = ({dato}) => {
    ...
    const borra_persona = () => {
        ...
        borra_personas(datos_cambios).then(() => {
            setIsModalDeleteOpen(false);
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title> {t("persona.borrarTitulo")}...</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {dato.habilita_3 == 'SI' ? (
                        <>
                            <h6>
                                <b>{t("persona.titulo")}:</b> {dato.nombre_persona}
                            </h6>
                        </>
                    ) : (
                        <>
