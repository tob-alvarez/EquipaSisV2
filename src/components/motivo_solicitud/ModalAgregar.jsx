...
import { alta_motivo_solicitudes } from "./funciones_motivo_solicitud";
...
const ModalAgregar = () => {
  ...
  const acepta_accion = () => {
    const datos_cambios = {
      id_motivo_solicitud: id_motivo_solicitud,
      nombre_motivo_solicitud: nombre_motivo_solicitud,
      habilita: habilita === true ? "1" : "0",
    };

    if (nombre_motivo_solicitud === "") {
      toast.error(`${t("motivo_solicitud.datoObligatorio")}`);
      return;
    }
    

    alta_motivo_solicitudes(datos_cambios).then((respuesta_accion) => {
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
          {t("motivo_solicitud.agregarTitulo")}
            <p
