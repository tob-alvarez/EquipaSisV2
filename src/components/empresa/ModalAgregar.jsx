...
import { alta_empresas } from "./funciones_empresa";
...
const ModalAgregar = () => {
  ...
  const acepta_accion = () => {
    ...
    if (nombre_empresa === "") {
      toast.error(`${t("empresa.datoObligatorio")}`);
      return;
    }
    

    alta_empresas(datos_cambios).then((respuesta_accion) => {
