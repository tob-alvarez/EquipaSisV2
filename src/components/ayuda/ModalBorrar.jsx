...
import { borra_ayudas } from "./funciones_ayuda";
...
const ModalBorrar = ({dato}) => {
    ...
    const borra_ayuda = () => {
        ...
        borra_ayudas(datos_cambios).then(() => {
            setIsModalDeleteOpen(false);
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title> {t("ayuda.borrarTitulo")}...</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {dato.habilita_3 == 'SI' ? (
                        <>
                            <h6>
                                <b>{t("ayuda.titulo")}:</b> {dato.nombre_ayuda}
                            </h6>
                        </>
                    ) : (
                        <>
