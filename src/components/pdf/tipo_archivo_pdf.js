...
export function tipo_archivo_pdf(filtro, idioma) {
    let titulo;
    let nombreAcciones;
    let habilitado;
    let page; 
    let reporte;
    if (idioma === 'es') {
      titulo = "Registro de Tipo de Archivo";
      nombreAcciones = "Nombre de Tipo de Archivo";
      habilitado = "Habilitado";
      page = "Página";
      reporte = "Reporte al"
    } else if (idioma === 'en') {
      titulo = "Records of File Type";
      nombreAcciones = "File Type";
      habilitado = "Enabled";
      page = "Page";
      reporte = "Report as of";
    } else if (idioma === 'por') {
      titulo = "Datas do Tipo de Arquivo";
      nombreAcciones = "Nome do Tipo de Arquivo";
      habilitado = "Habilitado";
      page = "Página";
  ...
  const resultado = async () => {
    ...
    item.id_tarchivo.toLowerCase().indexOf(filtro) > -1 ||
