...
import { borra_marcas } from "./funciones_marca";
...
const ModalBorrar = ({dato}) => {
    ...
    const borra_marca = () => {
        ...
        borra_marcas(datos_cambios).then(() => {
            setIsModalDeleteOpen(false);
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title> {t("marca.borrarTitulo")}...</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {dato.habilita_3 == 'SI' ? (
                        <>
                            <h6>
                                <b>{t("marca.titulo")}:</b> {dato.nombre_marca}
                            </h6>
                        </>
                    ) : (
                        <>
