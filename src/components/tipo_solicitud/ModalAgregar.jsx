...
import { alta_tipo_solicitudes } from "./funciones_tipo_solicitud";
...
const ModalAgregar = () => {
  ...
  const acepta_accion = () => {
    ...
    if (nombre_tsolicitud === "") {
      toast.error(`${t("tipo_solicitud.datoObligatorio")}`);
      return;
    }
    

    alta_tipo_solicitudes(datos_cambios).then((respuesta_accion) => {
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
          {t("tipo_solicitud.agregarTitulo")}
            <p
