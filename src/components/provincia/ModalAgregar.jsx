...
import { alta_provincias } from "./funciones_provincia";
...
const ModalAgregar = () => {
  ...
  const acepta_accion = () => {
    ...
    if (nombre_provincia === "") {
      toast.error(`${t("provincia.datoObligatorio")}`);
      return;
    }
    

    alta_provincias(datos_cambios).then((respuesta_accion) => {
