...
import { borra_empresas } from "./funciones_empresa";
...
const ModalBorrar = ({dato}) => {
    ...
    const borra_empresa = () => {
        ...
        borra_empresas(datos_cambios).then(() => {
            setIsModalDeleteOpen(false);
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title> {t("empresa.borrarTitulo")}...</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {dato.habilita_3 == 'SI' ? (
                        <>
                            <h6>
                                <b>{t("empresa.titulo")}:</b> {dato.nombre_empresa}
                            </h6>
                        </>
                    ) : (
                        <>
