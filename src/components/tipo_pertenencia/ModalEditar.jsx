...
import { cambia_tipo_pertenencias } from "./funciones_tipo_pertenencia";
...
const ModalEditar = ({dato}) => {
    ...
    useEffect(() => {
      if (isModalEditOpen && dato) {
        ...
        setNombre_tpertenencia(dato.nombre_tpertenencia);
      }
    ...
    const acepta_accion = () => {
      const datos_cambios = {
        ...
        nombre_tpertenencia: dato.nombre_tpertenencia,
        habilita: habilita === true ? "1" : "0",
      };
      if (nombre_tpertenencia == "") {
        toast.info(`${t("tipo_pertenencia.datoObligatorio")}`);
        return;
      }
  
      cambia_tipo_pertenencias(datos_cambios).then((respuesta_accion) => {
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
          {t("tipo_pertenencia.editarTitulo")}
            <p
