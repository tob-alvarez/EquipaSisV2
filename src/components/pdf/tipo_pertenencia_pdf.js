...
export function tipo_pertenencia_pdf(filtro, idioma) {
    let titulo;
    let nombreAcciones;
    let habilitado;
    let page; 
    let reporte;
    if (idioma === 'es') {
      titulo = "Registro de Tipo de Pertenencias";
      nombreAcciones = "Nombre de Tipo de Pertenencia";
      habilitado = "Habilitado";
      page = "Página";
      reporte = "Reporte al"
    } else if (idioma === 'en') {
      titulo = "Records of Ownership Type";
      nombreAcciones = "Ownership Type Name";
      habilitado = "Enabled";
      page = "Page";
      reporte = "Report as of";
    } else if (idioma === 'por') {
      titulo = "Datas do Tipo de Pertencimento";
      nombreAcciones = "Nome do Tipo de Pertencimento";
      habilitado = "Habilitado";
      page = "Página";
  ...
  const resultado = async () => {
    ...
    item.id_tpertenencia.toLowerCase().indexOf(filtro) > -1 ||
