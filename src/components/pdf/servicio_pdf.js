...
export function servicio_pdf(filtro) {
  ...
  const resultado = async () => {
    ...
    const endpoint = "https://v2.equipasis.com/api_desarrollo/servicio.php"; // API endpoint where we send form data.
    ...
    data.map((datos, index) => {
      if (index % 2 == 0 && datos.nombre_servicio.length > 120) {
      ...
      if (datos.nombre_servicio.length > 100) {
